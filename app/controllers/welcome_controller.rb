class WelcomeController < ApplicationController
  ...
  if params[:city] != nil
  	...
  	response  = HTTParty.get("http://api.wunderground.com/api/93b7fc7670c38b15/geolookup/conditions/q/#{params[:state]}/#{params[:city]}.json")
  ...
  def test
  	response  = HTTParty.get("http://api.wunderground.com/api/93b7fc7670c38b15/conditions/q/NY/Brooklyn.json")
